...
public class Post {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // optimizes performance by loading post authors only when explicitly accessed
    @JoinColumn(name = "author_id", nullable = false) //specifies that the column author_id will reference the author id
    private User author;
